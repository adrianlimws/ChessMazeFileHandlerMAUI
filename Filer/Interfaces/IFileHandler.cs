...
public interface IFileHandler
{
    ...
    void SaveGameLevel(ILevel level, string filePath);
    ...
    ILevel LoadGameLevel(string filePath);
    ...
    void SaveGameState(IGame game, string filePath);
    ...
    IGame LoadGameState(string filePath);
}